...
clear; close all; clc;
import org.opensim.modeling.* % import libraries

%% Set variables to use
modelFileName = 'model_scaled_calibrated.osim';                % The path to an input model
orientationsFileName = 'walk_001_orientations.sto';   % The path to orientation data for calibration 
...
resultsDirectory = 'IKResults'; % output folder

%% Instantiate an InverseKinematicsTool
imuIK = IMUInverseKinematicsTool('myIMUIK_Setup.xml'); % XML IK file
